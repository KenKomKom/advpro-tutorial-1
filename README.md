...
## REFLECTION 4
1. Menurut saya, prosedur TDD membantu saya dalam membuat kode yang lebih aman dengan lebih cepat. Dengan dibuatnya test terlebih dahulu, kode yang saya buat setelahnya terjamin pasti aman jika sudah lulus test yang saya buat. Selain itu, perubahan-perubahan yang dibuat terhadap kode juga bisa langsung diuji sehingga mempermudah proses refactoring. Untuk selanjutnya, saya rasa perlu ditambahkan pengujian untuk melihat pengaruh satu fitur dengan fitur lain untuk lebih menjamin kebenaran kode. Misal kita buat testing untuk membuat, mengupdate dan mendelete 100 produk sekaligus agar kita tahu kalau interaksi ketiga fitur tersebut berentet berjalan dengan benar dan bukan hanya benar saat berjalan secara sendiri-sendiri.
2. Menurut saya, test-test yang dibuat sudah memenuhi prinsip F.I.R.S.T karena telah dibuat algoritma testing yang seminimal mungkin untuk menguji keseluruhan kode yang ada. Tiap-tiap unit test juga terisolasi antar testnya sehingga tidak mempengaruhi hasil test yang lain. Tiap test juga menjalankan asersi untuk memastikan kebenaran output dan juga bisa digunakan berulang-ulang untuk tiap kali ada perubahan kode yang perlu diujikan.